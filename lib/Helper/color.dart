...
const Color primary = Color(0xffFD9701);
const Color secondary = Color(0xffFD9701);
const Color fontColor = Color(0xff4543C1);
const Color grad1Color = Color(0xffFD9701);
const Color grad2Color = Color(0xff73B934);
const Color lightWhite2 = Color(0xffEEF2F3);

const Color disableColor = Color(0xffEEF2F9);
const Color pink = Color(0xffEA1E63);
